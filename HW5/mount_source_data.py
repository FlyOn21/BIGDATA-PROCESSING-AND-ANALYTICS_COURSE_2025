...
def mount_source_data(
	extra_configs: dict[str, Any] | None = None,
	mount_name: str = 'zhogolev-pv-temp-files',
	source: str = 's3a://zhogolev-pv-temp-files/',
):
	"""
	...
	try:
		if extra_configs is None:
			extra_configs = {}
		dbutils.fs.mount(source=source, mount_point=f'/mnt/{mount_name}', extra_configs=extra_configs)
